...
public class Dchest extends TileEntity implements IInventory {
   ...
   public void updateEntity()
   {
       ...
       {
           worldObj.addBlockEvent(xCoord, yCoord, zCoord, blockRegist.Dchest, 3, ((numUsingPlayers << 3) & 0xF8) | (facing & 0x7));
       }
   ...
   public Dchest applyUpgradeItem(ItemChestChanger itemChestChanger)
   {
       if (numUsingPlayers > 0)
       {
           return null;
       ...
       Dchest newEntity = IronChestType.makeEntity(itemChestChanger.getTargetChestOrdinal(getType().ordinal()));
   ...
   public Dchest updateFromMetadata(int l)
   {
       if (worldObj != null && worldObj.isRemote)
       {
           if (l != type.ordinal())
           {
               ...
               return (Dchest) worldObj.getTileEntity(xCoord, yCoord, zCoord);
           }
       }
       return this;
   }
