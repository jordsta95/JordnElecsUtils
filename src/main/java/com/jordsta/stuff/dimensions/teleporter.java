...
public class teleporter extends BlockPortal {
	...
	public boolean func_150000_e(World world, int x, int y, int z){
		...
		if(world.getBlock(x-1, y, z) == blockRegist.endOre || world.getBlock(x+1, y, z) == blockRegist.endOre){
			b = 1;
		}
		if(world.getBlock(x, y, z-1) == blockRegist.endOre || world.getBlock(x, y, z-1) == blockRegist.endOre){
			b1 = 1;
		}
